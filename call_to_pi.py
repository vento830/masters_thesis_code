...
def make_and_send_picture(
    ...
    try:
        print(f"[INFO] Verbinde mit {hostname} als {username} …")
        ...
        print(f"[INFO] Führe auf dem Raspberry Pi aus: {remote_command}")
        ...
        print(f"[INFO] Die Datei '{remote_file_path}' wurde lokal als '{my_filename}' gespeichert.")
